...
<head>
 ...
 var codesite_token = "VltVPiZ7JsSfgbib2SxdUZjAMeM:1390098723367";
 
 
 var CS_env = {"token": "VltVPiZ7JsSfgbib2SxdUZjAMeM:1390098723367", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/11104804043454007890", "domainName": null, "projectHomeUrl": "/p/smhasher", "profileUrl": "/u/109814223914636253922/", "loggedInUserEmail": "alanparsonsproject28@gmail.com", "projectName": "smhasher", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": ""};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fsmhasher%2Fsource%2Fbrowse%2Ftrunk%2FPlatform.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/smhasher/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>Platform.cpp</span>
 ...
 <a href="/p/smhasher/source/browse/trunk/Platform.cpp?edit=1"
 ...
 <li><a href="/p/smhasher/source/browse/trunk/Platform.cpp?r=144" title="Previous">&lsaquo;r144</a></li>
...
><td class="source">void testRDTSC ( void )<br></td></tr
><tr
id=sl_svn151_6
...
><td class="source">  int64_t temp = rdtsc();<br></td></tr
><tr
id=sl_svn151_8
...
><td class="source">  printf(&quot;%d&quot;,(int)temp);<br></td></tr
><tr
id=sl_svn151_10
...
><td class="source">  SetProcessAffinityMask(GetCurrentProcess(),cpu);<br></td></tr
><tr
id=sl_svn151_19

><td class="source">  SetThreadPriority(GetCurrentThread(), THREAD_PRIORITY_HIGHEST);<br></td></tr
><tr
id=sl_svn151_20
...
><td class="source">#include &lt;sched.h&gt;<br></td></tr
><tr
id=sl_svn151_25
...
><td class="source">#if !defined(__CYGWIN__) &amp;&amp; !defined(__APPLE__)<br></td></tr
><tr
id=sl_svn151_29

><td class="source">  cpu_set_t mask;<br></td></tr
><tr
id=sl_svn151_30
...
><td class="source">  CPU_ZERO(&amp;mask);<br></td></tr
><tr
id=sl_svn151_32
...
><td class="source">  CPU_SET(2,&amp;mask);<br></td></tr
><tr
id=sl_svn151_34
...
><td class="source">  if( sched_setaffinity(0,sizeof(mask),&amp;mask) == -1)<br></td></tr
><tr
id=sl_svn151_36
...
><td class="source">    printf(&quot;WARNING: Could not set CPU affinity\n&quot;);<br></td></tr
><tr
id=sl_svn151_38
...
<script type="text/javascript">
 ...
 by tanjent
 on May 10, 2012
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=146&amp;format=side&amp;path=/trunk/Platform.cpp&amp;old_path=/trunk/Platform.cpp&amp;old=144">Diff</a>
 </div>
...
issues.</pre>
 ...
 var selected_path = '/trunk/Platform.cpp';
 ...
 by tanjent
 on Feb 29, 2012
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=144&amp;format=side&amp;path=/trunk/Platform.cpp&amp;old_path=/trunk/Platform.cpp&amp;old=132">Diff</a>
 <br>
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/smhasher/source/detail?spec=svn151&r=132">r132</a>
 by tanjent
 on Apr 12, 2011
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=132&amp;format=side&amp;path=/trunk/Platform.cpp&amp;old_path=/trunk/Platform.cpp&amp;old=123">Diff</a>
 <br>
 <pre class="ifOpened">Add Google's open-source CityHash
Fix build breakage on Cygwin</pre>
 </div>
 
 <div class="closed" style="margin-bottom:3px;" >
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/smhasher/source/detail?spec=svn151&r=123">r123</a>
 by aappl...@google.com
 on Apr 4, 2011
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=123&amp;format=side&amp;path=/trunk/Platform.cpp&amp;old_path=/trunk/Platform.cpp&amp;old=120">Diff</a>
 <br>
 <pre class="ifOpened">Add CPU affinity to gcc build

</pre>
 </div>
 
 
 <a href="/p/smhasher/source/list?path=/trunk/Platform.cpp&start=146">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//smhasher.googlecode.com/svn/trunk/Platform.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn151': '/trunk/Platform.cpp'}
 codereviews = CR_controller.setup(
 {"token": "VltVPiZ7JsSfgbib2SxdUZjAMeM:1390098723367", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/11104804043454007890", "domainName": null, "projectHomeUrl": "/p/smhasher", "profileUrl": "/u/109814223914636253922/", "loggedInUserEmail": "alanparsonsproject28@gmail.com", "projectName": "smhasher", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": ""}, '', 'svn151', paths,
