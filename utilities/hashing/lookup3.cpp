...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fsmhasher%2Fsource%2Fbrowse%2Ftrunk%2Flookup3.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/smhasher/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>lookup3.cpp</span>
 ...
 <a href="/p/smhasher/source/browse/trunk/lookup3.cpp?edit=1"
 ...
 <li><a href="/p/smhasher/source/browse/trunk/lookup3.cpp?r=92" title="Previous">&lsaquo;r92</a></li>
...
><td class="source">// lookup3 by Bob Jekins, code is public domain.<br></td></tr
><tr
id=sl_svn151_2
...
><td class="source">#define rot(x,k) (((x)&lt;&lt;(k)) | ((x)&gt;&gt;(32-(k))))<br></td></tr
><tr
id=sl_svn151_6
...
><td class="source">#define mix(a,b,c) \<br></td></tr
><tr
id=sl_svn151_8
...
><td class="source">  a -= c;  a ^= rot(c, 4);  c += b; \<br></td></tr
><tr
id=sl_svn151_10

><td class="source">  b -= a;  b ^= rot(a, 6);  a += c; \<br></td></tr
><tr
id=sl_svn151_11

><td class="source">  c -= b;  c ^= rot(b, 8);  b += a; \<br></td></tr
><tr
id=sl_svn151_12

><td class="source">  a -= c;  a ^= rot(c,16);  c += b; \<br></td></tr
><tr
id=sl_svn151_13

><td class="source">  b -= a;  b ^= rot(a,19);  a += c; \<br></td></tr
><tr
id=sl_svn151_14

><td class="source">  c -= b;  c ^= rot(b, 4);  b += a; \<br></td></tr
><tr
id=sl_svn151_15
...
><td class="source">#define final(a,b,c) \<br></td></tr
><tr
id=sl_svn151_18
...
><td class="source">  c ^= b; c -= rot(b,14); \<br></td></tr
><tr
id=sl_svn151_20

><td class="source">  a ^= c; a -= rot(c,11); \<br></td></tr
><tr
id=sl_svn151_21

><td class="source">  b ^= a; b -= rot(a,25); \<br></td></tr
><tr
id=sl_svn151_22

><td class="source">  c ^= b; c -= rot(b,16); \<br></td></tr
><tr
id=sl_svn151_23

><td class="source">  a ^= c; a -= rot(c,4);  \<br></td></tr
><tr
id=sl_svn151_24

><td class="source">  b ^= a; b -= rot(a,14); \<br></td></tr
><tr
id=sl_svn151_25

><td class="source">  c ^= b; c -= rot(b,24); \<br></td></tr
><tr
id=sl_svn151_26
...
><td class="source">uint32_t lookup3 ( const void * key, int length, uint32_t initval )<br></td></tr
><tr
id=sl_svn151_29
...
><td class="source">  uint32_t a,b,c;                                          /* internal state */<br></td></tr
><tr
id=sl_svn151_31
...
><td class="source">  a = b = c = 0xdeadbeef + ((uint32_t)length) + initval;<br></td></tr
><tr
id=sl_svn151_33
...
><td class="source">  const uint32_t *k = (const uint32_t *)key;         /* read 32-bit chunks */<br></td></tr
><tr
id=sl_svn151_35
...
><td class="source">  /*------ all but last block: aligned reads and affect 32 bits of (a,b,c) */<br></td></tr
><tr
id=sl_svn151_37

><td class="source">  while (length &gt; 12)<br></td></tr
><tr
id=sl_svn151_38
...
><td class="source">    a += k[0];<br></td></tr
><tr
id=sl_svn151_40

><td class="source">    b += k[1];<br></td></tr
><tr
id=sl_svn151_41

><td class="source">    c += k[2];<br></td></tr
><tr
id=sl_svn151_42

><td class="source">    mix(a,b,c);<br></td></tr
><tr
id=sl_svn151_43

><td class="source">    length -= 12;<br></td></tr
><tr
id=sl_svn151_44

><td class="source">    k += 3;<br></td></tr
><tr
id=sl_svn151_45
...
><td class="source">  switch(length)<br></td></tr
><tr
id=sl_svn151_48
...
><td class="source">    case 12: c+=k[2]; b+=k[1]; a+=k[0]; break;<br></td></tr
><tr
id=sl_svn151_50

><td class="source">    case 11: c+=k[2]&amp;0xffffff; b+=k[1]; a+=k[0]; break;<br></td></tr
><tr
id=sl_svn151_51

><td class="source">    case 10: c+=k[2]&amp;0xffff; b+=k[1]; a+=k[0]; break;<br></td></tr
><tr
id=sl_svn151_52

><td class="source">    case 9 : c+=k[2]&amp;0xff; b+=k[1]; a+=k[0]; break;<br></td></tr
><tr
id=sl_svn151_53

><td class="source">    case 8 : b+=k[1]; a+=k[0]; break;<br></td></tr
><tr
id=sl_svn151_54

><td class="source">    case 7 : b+=k[1]&amp;0xffffff; a+=k[0]; break;<br></td></tr
><tr
id=sl_svn151_55

><td class="source">    case 6 : b+=k[1]&amp;0xffff; a+=k[0]; break;<br></td></tr
><tr
id=sl_svn151_56

><td class="source">    case 5 : b+=k[1]&amp;0xff; a+=k[0]; break;<br></td></tr
><tr
id=sl_svn151_57

><td class="source">    case 4 : a+=k[0]; break;<br></td></tr
><tr
id=sl_svn151_58

><td class="source">    case 3 : a+=k[0]&amp;0xffffff; break;<br></td></tr
><tr
id=sl_svn151_59

><td class="source">    case 2 : a+=k[0]&amp;0xffff; break;<br></td></tr
><tr
id=sl_svn151_60

><td class="source">    case 1 : a+=k[0]&amp;0xff; break;<br></td></tr
><tr
id=sl_svn151_61

><td class="source">    case 0 : { return c; }              /* zero length strings require no mixing */<br></td></tr
><tr
id=sl_svn151_62
...
><td class="source">  final(a,b,c);<br></td></tr
><tr
id=sl_svn151_65
...
><td class="source">void lookup3_test ( const void * key, int len, uint32_t seed, void * out )<br></td></tr
><tr
id=sl_svn151_70
...
><td class="source">  *(uint32_t*)out = lookup3(key,len,seed);<br></td></tr
><tr
id=sl_svn151_72
...
<script type="text/javascript">
 ...
 by tanjent
 on Feb 29, 2012
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=144&amp;format=side&amp;path=/trunk/lookup3.cpp&amp;old_path=/trunk/lookup3.cpp&amp;old=92">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/lookup3.cpp';
 ...
 by tanjent
 on Mar 19, 2011
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=92&amp;format=side&amp;path=/trunk/lookup3.cpp&amp;old_path=/trunk/lookup3.cpp&amp;old=90">Diff</a>
 <br>
...
pstdint.h that break Ubuntu build
 ...
 by tanjent
 on Mar 19, 2011
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=90&amp;format=side&amp;path=/trunk/lookup3.cpp&amp;old_path=/trunk/lookup3.cpp&amp;old=2">Diff</a>
 <br>
...
De-tabulate all files</pre>
 ...
 by tanjent
 on Nov 1, 2010
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=2&amp;format=side&amp;path=/trunk/lookup3.cpp&amp;old_path=/trunk/lookup3.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">Initial source checkin</pre>
 </div>
 
 
 <a href="/p/smhasher/source/list?path=/trunk/lookup3.cpp&start=144">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//smhasher.googlecode.com/svn/trunk/lookup3.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn151': '/trunk/lookup3.cpp'}
