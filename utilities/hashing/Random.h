...
<head>
 ...
 var codesite_token = "H-JSagtQi1mECZXCdMOOd7Tv0Dg:1390098643151";
 
 
 var CS_env = {"relativeBaseUrl": "", "profileUrl": "/u/109814223914636253922/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/11104804043454007890", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "projectName": "smhasher", "loggedInUserEmail": "alanparsonsproject28@gmail.com", "projectHomeUrl": "/p/smhasher", "token": "H-JSagtQi1mECZXCdMOOd7Tv0Dg:1390098643151"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fsmhasher%2Fsource%2Fbrowse%2Ftrunk%2FRandom.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/smhasher/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>Random.h</span>
 ...
 <a href="/p/smhasher/source/browse/trunk/Random.h?edit=1"
 ...
 <li><a href="/p/smhasher/source/browse/trunk/Random.h?r=133" title="Previous">&lsaquo;r133</a></li>
...
><td class="source">// Xorshift RNG based on code by George Marsaglia<br></td></tr
><tr
id=sl_svn151_7

><td class="source">// http://en.wikipedia.org/wiki/Xorshift<br></td></tr
><tr
id=sl_svn151_8
...
><td class="source">struct Rand<br></td></tr
><tr
id=sl_svn151_10
...
><td class="source">  uint32_t x;<br></td></tr
><tr
id=sl_svn151_12

><td class="source">  uint32_t y;<br></td></tr
><tr
id=sl_svn151_13

><td class="source">  uint32_t z;<br></td></tr
><tr
id=sl_svn151_14

><td class="source">  uint32_t w;<br></td></tr
><tr
id=sl_svn151_15
...
><td class="source">    reseed(uint32_t(0));<br></td></tr
><tr
id=sl_svn151_19
...
><td class="source">  Rand( uint32_t seed )<br></td></tr
><tr
id=sl_svn151_22
...
><td class="source">    reseed(seed);<br></td></tr
><tr
id=sl_svn151_24
...
><td class="source">  void reseed ( uint32_t seed )<br></td></tr
><tr
id=sl_svn151_27
...
><td class="source">    x = 0x498b3bc5 ^ seed;<br></td></tr
><tr
id=sl_svn151_29
...
><td class="source">    z = 0;<br></td></tr
><tr
id=sl_svn151_31

><td class="source">    w = 0;<br></td></tr
><tr
id=sl_svn151_32
...
><td class="source">    for(int i = 0; i &lt; 10; i++) mix();<br></td></tr
><tr
id=sl_svn151_34
...
><td class="source">  void reseed ( uint64_t seed )<br></td></tr
><tr
id=sl_svn151_37
...
><td class="source">    x = 0x498b3bc5 ^ (uint32_t)(seed &gt;&gt;  0);<br></td></tr
><tr
id=sl_svn151_39

><td class="source">    y = 0x5a05089a ^ (uint32_t)(seed &gt;&gt; 32);<br></td></tr
><tr
id=sl_svn151_40
...
><td class="source">  void mix ( void )<br></td></tr
><tr
id=sl_svn151_49
...
><td class="source">    uint32_t t = x ^ (x &lt;&lt; 11);<br></td></tr
><tr
id=sl_svn151_51

><td class="source">    x = y; y = z; z = w;<br></td></tr
><tr
id=sl_svn151_52

><td class="source">    w = w ^ (w &gt;&gt; 19) ^ t ^ (t &gt;&gt; 8); <br></td></tr
><tr
id=sl_svn151_53
...
><td class="source">  uint32_t rand_u32 ( void )<br></td></tr
><tr
id=sl_svn151_56
...
><td class="source">  uint64_t rand_u64 ( void ) <br></td></tr
><tr
id=sl_svn151_63
...
><td class="source">    uint64_t a = x;<br></td></tr
><tr
id=sl_svn151_67

><td class="source">    uint64_t b = y;<br></td></tr
><tr
id=sl_svn151_68
...
><td class="source">    return (a &lt;&lt; 32) | b;<br></td></tr
><tr
id=sl_svn151_70
...
><td class="source">  void rand_p ( void * blob, int bytes )<br></td></tr
><tr
id=sl_svn151_73
...
><td class="source">    uint32_t * blocks = reinterpret_cast&lt;uint32_t*&gt;(blob);<br></td></tr
><tr
id=sl_svn151_75
...
><td class="source">    while(bytes &gt;= 4)<br></td></tr
><tr
id=sl_svn151_77
...
><td class="source">      blocks[0] = rand_u32();<br></td></tr
><tr
id=sl_svn151_79

><td class="source">      blocks++;<br></td></tr
><tr
id=sl_svn151_80

><td class="source">      bytes -= 4;<br></td></tr
><tr
id=sl_svn151_81
...
><td class="source">    uint8_t * tail = reinterpret_cast&lt;uint8_t*&gt;(blocks);<br></td></tr
><tr
id=sl_svn151_84
...
><td class="source">    for(int i = 0; i &lt; bytes; i++)<br></td></tr
><tr
id=sl_svn151_86
...
><td class="source">      tail[i] = (uint8_t)rand_u32();<br></td></tr
><tr
id=sl_svn151_88
...
><td class="source">extern Rand g_rand1;<br></td></tr
><tr
id=sl_svn151_95
...
><td class="source">inline uint32_t rand_u32 ( void ) { return g_rand1.rand_u32(); }<br></td></tr
><tr
id=sl_svn151_97

><td class="source">inline uint64_t rand_u64 ( void ) { return g_rand1.rand_u64(); }<br></td></tr
><tr
id=sl_svn151_98
...
><td class="source">inline void rand_p ( void * blob, int bytes )<br></td></tr
><tr
id=sl_svn151_100
...
><td class="source">  uint32_t * blocks = (uint32_t*)blob;<br></td></tr
><tr
id=sl_svn151_102
...
><td class="source">    *blocks++ = rand_u32();<br></td></tr
><tr
id=sl_svn151_106
...
><td class="source">  uint8_t * tail = (uint8_t*)blocks;<br></td></tr
><tr
id=sl_svn151_110
...
<script type="text/javascript">
 ...
 by tanjent
 on Feb 29, 2012
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=144&amp;format=side&amp;path=/trunk/Random.h&amp;old_path=/trunk/Random.h&amp;old=133">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/Random.h';
 ...
 <a href="/p/smhasher/source/detail?spec=svn151&r=133">r133</a>
 by aappl...@google.com
 on Apr 13, 2011
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=133&amp;format=side&amp;path=/trunk/Random.h&amp;old_path=/trunk/Random.h&amp;old=90">Diff</a>
 <br>
 <pre class="ifOpened">Enable all gcc warnings except strict
aliasing, fix build issues
 ...
 by tanjent
 on Mar 19, 2011
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=90&amp;format=side&amp;path=/trunk/Random.h&amp;old_path=/trunk/Random.h&amp;old=5">Diff</a>
 <br>
...
De-tabulate all files</pre>
 ...
 by tanjent
 on Nov 4, 2010
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=5&amp;format=side&amp;path=/trunk/Random.h&amp;old_path=/trunk/Random.h&amp;old=2">Diff</a>
 <br>
...
and all variants pass all tests)</pre>
 ...
 <a href="/p/smhasher/source/list?path=/trunk/Random.h&start=144">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//smhasher.googlecode.com/svn/trunk/Random.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn151': '/trunk/Random.h'}
 codereviews = CR_controller.setup(
 {"relativeBaseUrl": "", "profileUrl": "/u/109814223914636253922/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/11104804043454007890", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "projectName": "smhasher", "loggedInUserEmail": "alanparsonsproject28@gmail.com", "projectHomeUrl": "/p/smhasher", "token": "H-JSagtQi1mECZXCdMOOd7Tv0Dg:1390098643151"}, '', 'svn151', paths,
