...
<head>
 ...
 var codesite_token = "mktNgwe58ffTJ_P5ThQ0tnaAKMA:1390098738352";
 
 
 var CS_env = {"token": "mktNgwe58ffTJ_P5ThQ0tnaAKMA:1390098738352", "projectName": "smhasher", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "alanparsonsproject28@gmail.com", "profileUrl": "/u/109814223914636253922/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/11104804043454007890", "projectHomeUrl": "/p/smhasher", "relativeBaseUrl": ""};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fsmhasher%2Fsource%2Fbrowse%2Ftrunk%2FPMurHash.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/smhasher/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>PMurHash.h</span>
 ...
 <a href="/p/smhasher/source/browse/trunk/PMurHash.h?edit=1"
...
><td class="source">/* Determine what native type to use for uint32_t */<br></td></tr
><tr
id=sl_svn151_13
...
><td class="source">/* We can&#39;t use the name &#39;uint32_t&#39; here because it will conflict with<br></td></tr
><tr
id=sl_svn151_15

><td class="source"> * any version provided by the system headers or application. */<br></td></tr
><tr
id=sl_svn151_16
...
><td class="source">/* First look for special cases */<br></td></tr
><tr
id=sl_svn151_18
...
><td class="source">  #define MH_UINT32 unsigned long<br></td></tr
><tr
id=sl_svn151_20
...
><td class="source">/* If the compiler says it&#39;s C99 then take its word for it */<br></td></tr
><tr
id=sl_svn151_23

><td class="source">#if !defined(MH_UINT32) &amp;&amp; ( \<br></td></tr
><tr
id=sl_svn151_24

><td class="source">     defined(__STDC_VERSION__) &amp;&amp; __STDC_VERSION__ &gt;= 199901L )<br></td></tr
><tr
id=sl_svn151_25
...
><td class="source">  #define MH_UINT32 uint32_t<br></td></tr
><tr
id=sl_svn151_27
...
><td class="source">/* Otherwise try testing against max value macros from limit.h */<br></td></tr
><tr
id=sl_svn151_30
...
><td class="source">  #if   (USHRT_MAX == 0xffffffffUL)<br></td></tr
><tr
id=sl_svn151_33

><td class="source">    #define MH_UINT32 unsigned short<br></td></tr
><tr
id=sl_svn151_34

><td class="source">  #elif (UINT_MAX == 0xffffffffUL)<br></td></tr
><tr
id=sl_svn151_35

><td class="source">    #define MH_UINT32 unsigned int<br></td></tr
><tr
id=sl_svn151_36

><td class="source">  #elif (ULONG_MAX == 0xffffffffUL)<br></td></tr
><tr
id=sl_svn151_37
...
><td class="source">  #error Unable to determine type name for unsigned 32-bit int<br></td></tr
><tr
id=sl_svn151_43
...
><td class="source">/* I&#39;m yet to work on a platform where &#39;unsigned char&#39; is not 8 bits */<br></td></tr
><tr
id=sl_svn151_46

><td class="source">#define MH_UINT8  unsigned char<br></td></tr
><tr
id=sl_svn151_47
...
><td class="source">void PMurHash32_Process(MH_UINT32 *ph1, MH_UINT32 *pcarry, const void *key, int len);<br></td></tr
><tr
id=sl_svn151_57

><td class="source">MH_UINT32 PMurHash32_Result(MH_UINT32 h1, MH_UINT32 carry, MH_UINT32 total_length);<br></td></tr
><tr
id=sl_svn151_58

><td class="source">MH_UINT32 PMurHash32(MH_UINT32 seed, const void *key, int len);<br></td></tr
><tr
id=sl_svn151_59
...
><td class="source">void PMurHash32_test(const void *key, int len, MH_UINT32 seed, void *out);<br></td></tr
><tr
id=sl_svn151_61
...
<script type="text/javascript">
 ...
 by tanjent
 on May 10, 2012
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=146&amp;format=side&amp;path=/trunk/PMurHash.h&amp;old_path=/trunk/PMurHash.h&amp;old=">Diff</a>
 </div>
...
issues.</pre>
 ...
 var selected_path = '/trunk/PMurHash.h';
 ...
 <a href="/p/smhasher/source/list?path=/trunk/PMurHash.h&start=146">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//smhasher.googlecode.com/svn/trunk/PMurHash.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn151': '/trunk/PMurHash.h'}
 codereviews = CR_controller.setup(
 {"token": "mktNgwe58ffTJ_P5ThQ0tnaAKMA:1390098738352", "projectName": "smhasher", "domainName": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "alanparsonsproject28@gmail.com", "profileUrl": "/u/109814223914636253922/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/11104804043454007890", "projectHomeUrl": "/p/smhasher", "relativeBaseUrl": ""}, '', 'svn151', paths,
