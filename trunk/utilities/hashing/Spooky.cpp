...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fsmhasher%2Fsource%2Fbrowse%2Ftrunk%2FSpooky.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/smhasher/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>Spooky.cpp</span>
 ...
 <a href="/p/smhasher/source/browse/trunk/Spooky.cpp?edit=1"
 ...
 <li><a href="/p/smhasher/source/browse/branches/chandlerc_dev/Spooky.cpp?r=143" title="Previous">&lsaquo;r143</a></li>
...
><td class="source">// Spooky Hash<br></td></tr
><tr
id=sl_svn151_2

><td class="source">// A 128-bit noncryptographic hash, for checksums and table lookup<br></td></tr
><tr
id=sl_svn151_3

><td class="source">// By Bob Jenkins.  Public domain.<br></td></tr
><tr
id=sl_svn151_4

><td class="source">//   Oct 31 2010: published framework, disclaimer ShortHash isn&#39;t right<br></td></tr
><tr
id=sl_svn151_5

><td class="source">//   Nov 7 2010: disabled ShortHash<br></td></tr
><tr
id=sl_svn151_6

><td class="source">//   Oct 31 2011: replace End, ShortMix, ShortEnd, enable ShortHash again<br></td></tr
><tr
id=sl_svn151_7
...
><td class="source">#include &quot;Spooky.h&quot;<br></td></tr
><tr
id=sl_svn151_10
...
><td class="source">#define ALLOW_UNALIGNED_READS 1<br></td></tr
><tr
id=sl_svn151_12
...
><td class="source">// short hash ... it could be used on any message, <br></td></tr
><tr
id=sl_svn151_15

><td class="source">// but it&#39;s used by Spooky just for short messages.<br></td></tr
><tr
id=sl_svn151_16
...
><td class="source">void SpookyHash::Short(<br></td></tr
><tr
id=sl_svn151_18

><td class="source">    const void *message,<br></td></tr
><tr
id=sl_svn151_19

><td class="source">    size_t length,<br></td></tr
><tr
id=sl_svn151_20

><td class="source">    uint64 *hash1,<br></td></tr
><tr
id=sl_svn151_21

><td class="source">    uint64 *hash2)<br></td></tr
><tr
id=sl_svn151_22
...
><td class="source">    uint64 buf[sc_numVars];<br></td></tr
><tr
id=sl_svn151_24

><td class="source">    union <br></td></tr
><tr
id=sl_svn151_25
...
><td class="source">        const uint8 *p8; <br></td></tr
><tr
id=sl_svn151_27

><td class="source">        uint32 *p32;<br></td></tr
><tr
id=sl_svn151_28

><td class="source">        uint64 *p64; <br></td></tr
><tr
id=sl_svn151_29
...
><td class="source">    u.p8 = (const uint8 *)message;<br></td></tr
><tr
id=sl_svn151_33
...
><td class="source">    if (!ALLOW_UNALIGNED_READS &amp;&amp; (u.i &amp; 0x7))<br></td></tr
><tr
id=sl_svn151_35
...
><td class="source">        memcpy(buf, message, length);<br></td></tr
><tr
id=sl_svn151_37

><td class="source">        u.p64 = buf;<br></td></tr
><tr
id=sl_svn151_38
...
><td class="source">    size_t remainder = length%32;<br></td></tr
><tr
id=sl_svn151_41

><td class="source">    uint64 a=*hash1;<br></td></tr
><tr
id=sl_svn151_42

><td class="source">    uint64 b=*hash2;<br></td></tr
><tr
id=sl_svn151_43

><td class="source">    uint64 c=sc_const;<br></td></tr
><tr
id=sl_svn151_44

><td class="source">    uint64 d=sc_const;<br></td></tr
><tr
id=sl_svn151_45
...
><td class="source">    if (length &gt; 15)<br></td></tr
><tr
id=sl_svn151_47
...
><td class="source">        const uint64 *end = u.p64 + (length/32)*4;<br></td></tr
><tr
id=sl_svn151_49
...
><td class="source">        // handle all complete sets of 32 bytes<br></td></tr
><tr
id=sl_svn151_51

><td class="source">        for (; u.p64 &lt; end; u.p64 += 4)<br></td></tr
><tr
id=sl_svn151_52
...
><td class="source">            c += u.p64[0];<br></td></tr
><tr
id=sl_svn151_54

><td class="source">            d += u.p64[1];<br></td></tr
><tr
id=sl_svn151_55

><td class="source">            ShortMix(a,b,c,d);<br></td></tr
><tr
id=sl_svn151_56

><td class="source">            a += u.p64[2];<br></td></tr
><tr
id=sl_svn151_57

><td class="source">            b += u.p64[3];<br></td></tr
><tr
id=sl_svn151_58
...
><td class="source">        //Handle the case of 16+ remaining bytes.<br></td></tr
><tr
id=sl_svn151_61

><td class="source">        if (remainder &gt;= 16)<br></td></tr
><tr
id=sl_svn151_62
...
><td class="source">            u.p64 += 2;<br></td></tr
><tr
id=sl_svn151_67

><td class="source">            remainder -= 16;<br></td></tr
><tr
id=sl_svn151_68
...
><td class="source">    // Handle the last 0..15 bytes, and its length<br></td></tr
><tr
id=sl_svn151_72

><td class="source">    d = ((uint64)length) &lt;&lt; 56;<br></td></tr
><tr
id=sl_svn151_73

><td class="source">    switch (remainder)<br></td></tr
><tr
id=sl_svn151_74
...
><td class="source">    d += ((uint64)u.p8[14]) &lt;&lt; 48;<br></td></tr
><tr
id=sl_svn151_77
...
><td class="source">        d += ((uint64)u.p8[13]) &lt;&lt; 40;<br></td></tr
><tr
id=sl_svn151_79
...
><td class="source">        d += ((uint64)u.p8[12]) &lt;&lt; 32;<br></td></tr
><tr
id=sl_svn151_81
...
><td class="source">        d += u.p32[2];<br></td></tr
><tr
id=sl_svn151_83
...
><td class="source">        d += ((uint64)u.p8[10]) &lt;&lt; 16;<br></td></tr
><tr
id=sl_svn151_87
...
><td class="source">        d += ((uint64)u.p8[9]) &lt;&lt; 8;<br></td></tr
><tr
id=sl_svn151_89
...
><td class="source">        d += (uint64)u.p8[8];<br></td></tr
><tr
id=sl_svn151_91
...
><td class="source">        c += ((uint64)u.p8[6]) &lt;&lt; 48;<br></td></tr
><tr
id=sl_svn151_96
...
><td class="source">        c += ((uint64)u.p8[5]) &lt;&lt; 40;<br></td></tr
><tr
id=sl_svn151_98
...
><td class="source">        c += ((uint64)u.p8[4]) &lt;&lt; 32;<br></td></tr
><tr
id=sl_svn151_100
...
><td class="source">        c += u.p32[0];<br></td></tr
><tr
id=sl_svn151_102
...
><td class="source">        c += ((uint64)u.p8[2]) &lt;&lt; 16;<br></td></tr
><tr
id=sl_svn151_105
...
><td class="source">        c += ((uint64)u.p8[1]) &lt;&lt; 8;<br></td></tr
><tr
id=sl_svn151_107
...
><td class="source">        c += (uint64)u.p8[0];<br></td></tr
><tr
id=sl_svn151_109
...
><td class="source">        c += sc_const;<br></td></tr
><tr
id=sl_svn151_112

><td class="source">        d += sc_const;<br></td></tr
><tr
id=sl_svn151_113
...
><td class="source">    ShortEnd(a,b,c,d);<br></td></tr
><tr
id=sl_svn151_115

><td class="source">    *hash1 = a;<br></td></tr
><tr
id=sl_svn151_116

><td class="source">    *hash2 = b;<br></td></tr
><tr
id=sl_svn151_117
...
><td class="source">// do the whole hash in one call<br></td></tr
><tr
id=sl_svn151_123

><td class="source">void SpookyHash::Hash128(<br></td></tr
><tr
id=sl_svn151_124
...
><td class="source">    if (length &lt; sc_bufSize)<br></td></tr
><tr
id=sl_svn151_130
...
><td class="source">        Short(message, length, hash1, hash2);<br></td></tr
><tr
id=sl_svn151_132
...
><td class="source">    uint64 h0,h1,h2,h3,h4,h5,h6,h7,h8,h9,h10,h11;<br></td></tr
><tr
id=sl_svn151_136
...
><td class="source">    uint64 *end;<br></td></tr
><tr
id=sl_svn151_138
...
><td class="source">    size_t remainder;<br></td></tr
><tr
id=sl_svn151_145
...
><td class="source">    h0=h3=h6=h9  = *hash1;<br></td></tr
><tr
id=sl_svn151_147

><td class="source">    h1=h4=h7=h10 = *hash2;<br></td></tr
><tr
id=sl_svn151_148

><td class="source">    h2=h5=h8=h11 = sc_const;<br></td></tr
><tr
id=sl_svn151_149
...
><td class="source">    end = u.p64 + (length/sc_blockSize)*sc_numVars;<br></td></tr
><tr
id=sl_svn151_152
...
><td class="source">    // handle all whole sc_blockSize blocks of bytes<br></td></tr
><tr
id=sl_svn151_154

><td class="source">    if (ALLOW_UNALIGNED_READS || ((u.i &amp; 0x7) == 0))<br></td></tr
><tr
id=sl_svn151_155
...
><td class="source">        while (u.p64 &lt; end)<br></td></tr
><tr
id=sl_svn151_157
...
><td class="source">            Mix(u.p64, h0,h1,h2,h3,h4,h5,h6,h7,h8,h9,h10,h11);<br></td></tr
><tr
id=sl_svn151_159

><td class="source">	    u.p64 += sc_numVars;<br></td></tr
><tr
id=sl_svn151_160
...
><td class="source">            memcpy(buf, u.p64, sc_blockSize);<br></td></tr
><tr
id=sl_svn151_167

><td class="source">            Mix(buf, h0,h1,h2,h3,h4,h5,h6,h7,h8,h9,h10,h11);<br></td></tr
><tr
id=sl_svn151_168
...
><td class="source">    // handle the last partial block of sc_blockSize bytes<br></td></tr
><tr
id=sl_svn151_173

><td class="source">    remainder = (length - ((const uint8 *)end-(const uint8 *)message));<br></td></tr
><tr
id=sl_svn151_174

><td class="source">    memcpy(buf, end, remainder);<br></td></tr
><tr
id=sl_svn151_175

><td class="source">    memset(((uint8 *)buf)+remainder, 0, sc_blockSize-remainder);<br></td></tr
><tr
id=sl_svn151_176

><td class="source">    ((uint8 *)buf)[sc_blockSize-1] = remainder;<br></td></tr
><tr
id=sl_svn151_177
...
><td class="source">    // do some final mixing <br></td></tr
><tr
id=sl_svn151_180

><td class="source">    End(h0,h1,h2,h3,h4,h5,h6,h7,h8,h9,h10,h11);<br></td></tr
><tr
id=sl_svn151_181

><td class="source">    *hash1 = h0;<br></td></tr
><tr
id=sl_svn151_182

><td class="source">    *hash2 = h1;<br></td></tr
><tr
id=sl_svn151_183
...
><td class="source">// init spooky state<br></td></tr
><tr
id=sl_svn151_188

><td class="source">void SpookyHash::Init(uint64 seed1, uint64 seed2)<br></td></tr
><tr
id=sl_svn151_189
...
><td class="source">    m_length = 0;<br></td></tr
><tr
id=sl_svn151_191

><td class="source">    m_remainder = 0;<br></td></tr
><tr
id=sl_svn151_192

><td class="source">    m_state[0] = seed1;<br></td></tr
><tr
id=sl_svn151_193

><td class="source">    m_state[1] = seed2;<br></td></tr
><tr
id=sl_svn151_194
...
><td class="source">// add a message fragment to the state<br></td></tr
><tr
id=sl_svn151_198

><td class="source">void SpookyHash::Update(const void *message, size_t length)<br></td></tr
><tr
id=sl_svn151_199
...
><td class="source">    size_t newLength = length + m_remainder;<br></td></tr
><tr
id=sl_svn151_202

><td class="source">    uint8  remainder;<br></td></tr
><tr
id=sl_svn151_203
...
><td class="source">    const uint64 *end;<br></td></tr
><tr
id=sl_svn151_210
...
><td class="source">    // Is this message fragment too short?  If it is, stuff it away.<br></td></tr
><tr
id=sl_svn151_212

><td class="source">    if (newLength &lt; sc_bufSize)<br></td></tr
><tr
id=sl_svn151_213
...
><td class="source">        memcpy(&amp;((uint8 *)m_data)[m_remainder], message, length);<br></td></tr
><tr
id=sl_svn151_215

><td class="source">        m_length = length + m_length;<br></td></tr
><tr
id=sl_svn151_216

><td class="source">        m_remainder = (uint8)newLength;<br></td></tr
><tr
id=sl_svn151_217
...
><td class="source">    // init the variables<br></td></tr
><tr
id=sl_svn151_221

><td class="source">    if (m_length &lt; sc_bufSize)<br></td></tr
><tr
id=sl_svn151_222
...
><td class="source">        h0=h3=h6=h9  = m_state[0];<br></td></tr
><tr
id=sl_svn151_224

><td class="source">        h1=h4=h7=h10 = m_state[1];<br></td></tr
><tr
id=sl_svn151_225
...
><td class="source">        h0 = m_state[0];<br></td></tr
><tr
id=sl_svn151_230

><td class="source">        h1 = m_state[1];<br></td></tr
><tr
id=sl_svn151_231

><td class="source">        h2 = m_state[2];<br></td></tr
><tr
id=sl_svn151_232

><td class="source">        h3 = m_state[3];<br></td></tr
><tr
id=sl_svn151_233

><td class="source">        h4 = m_state[4];<br></td></tr
><tr
id=sl_svn151_234

><td class="source">        h5 = m_state[5];<br></td></tr
><tr
id=sl_svn151_235

><td class="source">        h6 = m_state[6];<br></td></tr
><tr
id=sl_svn151_236

><td class="source">        h7 = m_state[7];<br></td></tr
><tr
id=sl_svn151_237

><td class="source">        h8 = m_state[8];<br></td></tr
><tr
id=sl_svn151_238

><td class="source">        h9 = m_state[9];<br></td></tr
><tr
id=sl_svn151_239

><td class="source">        h10 = m_state[10];<br></td></tr
><tr
id=sl_svn151_240

><td class="source">        h11 = m_state[11];<br></td></tr
><tr
id=sl_svn151_241
...
><td class="source">    // if we&#39;ve got anything stuffed away, use it now<br></td></tr
><tr
id=sl_svn151_245

><td class="source">    if (m_remainder)<br></td></tr
><tr
id=sl_svn151_246
...
><td class="source">        uint8 prefix = sc_bufSize-m_remainder;<br></td></tr
><tr
id=sl_svn151_248

><td class="source">        memcpy(&amp;(((uint8 *)m_data)[m_remainder]), message, prefix);<br></td></tr
><tr
id=sl_svn151_249

><td class="source">        u.p64 = m_data;<br></td></tr
><tr
id=sl_svn151_250
...
><td class="source">        Mix(&amp;u.p64[sc_numVars], h0,h1,h2,h3,h4,h5,h6,h7,h8,h9,h10,h11);<br></td></tr
><tr
id=sl_svn151_252

><td class="source">        u.p8 = ((const uint8 *)message) + prefix;<br></td></tr
><tr
id=sl_svn151_253

><td class="source">        length -= prefix;<br></td></tr
><tr
id=sl_svn151_254
...
><td class="source">    // handle all whole blocks of sc_blockSize bytes<br></td></tr
><tr
id=sl_svn151_261
...
><td class="source">    remainder = (uint8)(length-((const uint8 *)end-u.p8));<br></td></tr
><tr
id=sl_svn151_263
...
><td class="source">            memcpy(m_data, u.p8, sc_blockSize);<br></td></tr
><tr
id=sl_svn151_276

><td class="source">            Mix(m_data, h0,h1,h2,h3,h4,h5,h6,h7,h8,h9,h10,h11);<br></td></tr
><tr
id=sl_svn151_277
...
><td class="source">    // stuff away the last few bytes<br></td></tr
><tr
id=sl_svn151_282

><td class="source">    m_remainder = remainder;<br></td></tr
><tr
id=sl_svn151_283

><td class="source">    memcpy(m_data, end, remainder);<br></td></tr
><tr
id=sl_svn151_284
...
><td class="source">    // stuff away the variables<br></td></tr
><tr
id=sl_svn151_286

><td class="source">    m_state[0] = h0;<br></td></tr
><tr
id=sl_svn151_287

><td class="source">    m_state[1] = h1;<br></td></tr
><tr
id=sl_svn151_288

><td class="source">    m_state[2] = h2;<br></td></tr
><tr
id=sl_svn151_289

><td class="source">    m_state[3] = h3;<br></td></tr
><tr
id=sl_svn151_290

><td class="source">    m_state[4] = h4;<br></td></tr
><tr
id=sl_svn151_291

><td class="source">    m_state[5] = h5;<br></td></tr
><tr
id=sl_svn151_292

><td class="source">    m_state[6] = h6;<br></td></tr
><tr
id=sl_svn151_293

><td class="source">    m_state[7] = h7;<br></td></tr
><tr
id=sl_svn151_294

><td class="source">    m_state[8] = h8;<br></td></tr
><tr
id=sl_svn151_295

><td class="source">    m_state[9] = h9;<br></td></tr
><tr
id=sl_svn151_296

><td class="source">    m_state[10] = h10;<br></td></tr
><tr
id=sl_svn151_297

><td class="source">    m_state[11] = h11;<br></td></tr
><tr
id=sl_svn151_298
...
><td class="source">// report the hash for the concatenation of all message fragments so far<br></td></tr
><tr
id=sl_svn151_302

><td class="source">void SpookyHash::Final(uint64 *hash1, uint64 *hash2)<br></td></tr
><tr
id=sl_svn151_303
...
><td class="source">        Short( m_data, m_length, hash1, hash2);<br></td></tr
><tr
id=sl_svn151_308
...
><td class="source">    const uint64 *data = (const uint64 *)m_data;<br></td></tr
><tr
id=sl_svn151_312

><td class="source">    uint8 remainder = m_remainder;<br></td></tr
><tr
id=sl_svn151_313
...
><td class="source">    uint64 h0 = m_state[0];<br></td></tr
><tr
id=sl_svn151_315

><td class="source">    uint64 h1 = m_state[1];<br></td></tr
><tr
id=sl_svn151_316

><td class="source">    uint64 h2 = m_state[2];<br></td></tr
><tr
id=sl_svn151_317

><td class="source">    uint64 h3 = m_state[3];<br></td></tr
><tr
id=sl_svn151_318

><td class="source">    uint64 h4 = m_state[4];<br></td></tr
><tr
id=sl_svn151_319

><td class="source">    uint64 h5 = m_state[5];<br></td></tr
><tr
id=sl_svn151_320

><td class="source">    uint64 h6 = m_state[6];<br></td></tr
><tr
id=sl_svn151_321

><td class="source">    uint64 h7 = m_state[7];<br></td></tr
><tr
id=sl_svn151_322

><td class="source">    uint64 h8 = m_state[8];<br></td></tr
><tr
id=sl_svn151_323

><td class="source">    uint64 h9 = m_state[9];<br></td></tr
><tr
id=sl_svn151_324

><td class="source">    uint64 h10 = m_state[10];<br></td></tr
><tr
id=sl_svn151_325

><td class="source">    uint64 h11 = m_state[11];<br></td></tr
><tr
id=sl_svn151_326
...
><td class="source">    if (remainder &gt;= sc_blockSize)<br></td></tr
><tr
id=sl_svn151_328
...
><td class="source">        // m_data can contain two blocks; handle any whole first block<br></td></tr
><tr
id=sl_svn151_330

><td class="source">        Mix(data, h0,h1,h2,h3,h4,h5,h6,h7,h8,h9,h10,h11);<br></td></tr
><tr
id=sl_svn151_331

><td class="source">	data += sc_numVars;<br></td></tr
><tr
id=sl_svn151_332

><td class="source">	remainder -= sc_blockSize;<br></td></tr
><tr
id=sl_svn151_333
...
><td class="source">    // mix in the last partial block, and the length mod sc_blockSize<br></td></tr
><tr
id=sl_svn151_336

><td class="source">    memset(&amp;((uint8 *)data)[remainder], 0, (sc_blockSize-remainder));<br></td></tr
><tr
id=sl_svn151_337
...
><td class="source">    ((uint8 *)data)[sc_blockSize-1] = remainder;<br></td></tr
><tr
id=sl_svn151_339
...
<script type="text/javascript">
 ...
 by tanjent
 on Feb 29, 2012
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=144&amp;format=side&amp;path=/trunk/Spooky.cpp&amp;old_path=/branches/chandlerc_dev/Spooky.cpp&amp;old=142">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/Spooky.cpp';
 ...
 <a href="/p/smhasher/source/detail?spec=svn151&r=142">r142</a>
 by chandl...@google.com
 on Feb 29, 2012
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=142&amp;format=side&amp;path=/branches/chandlerc_dev/Spooky.cpp&amp;old_path=/branches/chandlerc_dev/Spooky.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">Add Jenkins' Spooky hash to SMHasher's
suite, in 32-bit, 64-bit, and
128-bit variations.</pre>
 </div>
 
 
 <a href="/p/smhasher/source/list?path=/trunk/Spooky.cpp&start=144">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//smhasher.googlecode.com/svn/trunk/Spooky.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn151': '/trunk/Spooky.cpp'}
