...
<head>
 ...
 var codesite_token = "PGKLnVGUSbULylyCcKpEMLqYwvk:1390098571116";
 
 
 var CS_env = {"relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/11104804043454007890", "domainName": null, "profileUrl": "/u/109814223914636253922/", "projectName": "smhasher", "projectHomeUrl": "/p/smhasher", "token": "PGKLnVGUSbULylyCcKpEMLqYwvk:1390098571116", "loggedInUserEmail": "alanparsonsproject28@gmail.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fsmhasher%2Fsource%2Fbrowse%2Ftrunk%2FMurmurHash3.h" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/smhasher/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>MurmurHash3.h</span>
 ...
 <a href="/p/smhasher/source/browse/trunk/MurmurHash3.h?edit=1"
 ...
 <li><a href="/p/smhasher/source/browse/trunk/MurmurHash3.h?r=144" title="Previous">&lsaquo;r144</a></li>
...
><td class="source">#ifndef _MURMURHASH3_H_<br></td></tr
><tr
id=sl_svn151_6

><td class="source">#define _MURMURHASH3_H_<br></td></tr
><tr
id=sl_svn151_7
...
><td class="source">void MurmurHash3_x86_32  ( const void * key, int len, uint32_t seed, void * out );<br></td></tr
><tr
id=sl_svn151_30
...
><td class="source">void MurmurHash3_x86_128 ( const void * key, int len, uint32_t seed, void * out );<br></td></tr
><tr
id=sl_svn151_32
...
><td class="source">void MurmurHash3_x64_128 ( const void * key, int len, uint32_t seed, void * out );<br></td></tr
><tr
id=sl_svn151_34
...
><td class="source">#endif // _MURMURHASH3_H_<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/smhasher/source/detail?spec=svn151&amp;r=151">r151</a>
 by aappl...@google.com
 on Dec 30, 2013
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=151&amp;format=side&amp;path=/trunk/MurmurHash3.h&amp;old_path=/trunk/MurmurHash3.h&amp;old=144">Diff</a>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/smhasher/source/detail?r=151&spec=svn151';
 var publish_url = '/p/smhasher/source/detail?r=151&spec=svn151#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/trunk/MurmurHash1.h');
 changed_urls.push('/p/smhasher/source/browse/trunk/MurmurHash1.h?r\x3d151\x26spec\x3dsvn151');
 
 
 changed_paths.push('/trunk/MurmurHash2.h');
 changed_urls.push('/p/smhasher/source/browse/trunk/MurmurHash2.h?r\x3d151\x26spec\x3dsvn151');
 
 
 changed_paths.push('/trunk/MurmurHash3.h');
 changed_urls.push('/p/smhasher/source/browse/trunk/MurmurHash3.h?r\x3d151\x26spec\x3dsvn151');
 
 var selected_path = '/trunk/MurmurHash3.h';
 
 
 changed_paths.push('/trunk/pstdint.h');
 changed_urls.push('/p/smhasher/source/browse/trunk/pstdint.h?r\x3d151\x26spec\x3dsvn151');
 ...
 <option value="/p/smhasher/source/browse/trunk/MurmurHash1.h?r=151&amp;spec=svn151"
 
 >/trunk/MurmurHash1.h</option>
 
 <option value="/p/smhasher/source/browse/trunk/MurmurHash2.h?r=151&amp;spec=svn151"
 
 >/trunk/MurmurHash2.h</option>
 
 <option value="/p/smhasher/source/browse/trunk/MurmurHash3.h?r=151&amp;spec=svn151"
 selected="selected"
 >/trunk/MurmurHash3.h</option>
 
 <option value="/p/smhasher/source/browse/trunk/pstdint.h?r=151&amp;spec=svn151"
 ...
 by tanjent
 on Feb 29, 2012
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=144&amp;format=side&amp;path=/trunk/MurmurHash3.h&amp;old_path=/trunk/MurmurHash3.h&amp;old=129">Diff</a>
 <br>
 ...
 by aappl...@google.com
 on Apr 8, 2011
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=129&amp;format=side&amp;path=/trunk/MurmurHash3.h&amp;old_path=/trunk/MurmurHash3.h&amp;old=127">Diff</a>
 <br>
...
licensing &amp; no external dependencies
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/smhasher/source/detail?spec=svn151&r=127">r127</a>
 by aappl...@google.com
 on Apr 8, 2011
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=127&amp;format=side&amp;path=/trunk/MurmurHash3.h&amp;old_path=/trunk/MurmurHash3.h&amp;old=126">Diff</a>
 <br>
 <pre class="ifOpened">gcc complains about multiply defined
symbols, move rotl macros back to
source file
 ...
 <a href="/p/smhasher/source/list?path=/trunk/MurmurHash3.h&start=151">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//smhasher.googlecode.com/svn/trunk/MurmurHash3.h">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn151': '/trunk/MurmurHash3.h'}
 codereviews = CR_controller.setup(
 {"relativeBaseUrl": "", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/11104804043454007890", "domainName": null, "profileUrl": "/u/109814223914636253922/", "projectName": "smhasher", "projectHomeUrl": "/p/smhasher", "token": "PGKLnVGUSbULylyCcKpEMLqYwvk:1390098571116", "loggedInUserEmail": "alanparsonsproject28@gmail.com"}, '', 'svn151', paths,
