...
<head>
 ...
 var codesite_token = "imrLjL84zQJ_DZTM7KXCfS6_3kU:1390098539271";
 
 
 var CS_env = {"assetVersionPath": "https://ssl.gstatic.com/codesite/ph/11104804043454007890", "profileUrl": "/u/109814223914636253922/", "loggedInUserEmail": "alanparsonsproject28@gmail.com", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "projectHomeUrl": "/p/smhasher", "projectName": "smhasher", "token": "imrLjL84zQJ_DZTM7KXCfS6_3kU:1390098539271", "domainName": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fsmhasher%2Fsource%2Fbrowse%2Ftrunk%2FSuperFastHash.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/smhasher/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span>SuperFastHash.cpp</span>
 ...
 <a href="/p/smhasher/source/browse/trunk/SuperFastHash.cpp?edit=1"
 ...
 <li><a href="/p/smhasher/source/browse/trunk/SuperFastHash.cpp?r=128" title="Previous">&lsaquo;r128</a></li>
...
><td class="source">#include &lt;stdio.h&gt; // for NULL<br></td></tr
><tr
id=sl_svn151_3
...
><td class="source">/* By Paul Hsieh (C) 2004, 2005.  Covered under the Paul Hsieh derivative <br></td></tr
><tr
id=sl_svn151_5

><td class="source">   license. See: <br></td></tr
><tr
id=sl_svn151_6

><td class="source">   http://www.azillionmonkeys.com/qed/weblicense.html for license details.<br></td></tr
><tr
id=sl_svn151_7
...
><td class="source">   http://www.azillionmonkeys.com/qed/hash.html */<br></td></tr
><tr
id=sl_svn151_9
...
><td class="source">#undef get16bits<br></td></tr
><tr
id=sl_svn151_12

><td class="source">#if (defined(__GNUC__) &amp;&amp; defined(__i386__)) || defined(__WATCOMC__) \<br></td></tr
><tr
id=sl_svn151_13

><td class="source">  || defined(_MSC_VER) || defined (__BORLANDC__) || defined (__TURBOC__)<br></td></tr
><tr
id=sl_svn151_14

><td class="source">#define get16bits(d) (*((const uint16_t *) (d)))<br></td></tr
><tr
id=sl_svn151_15
...
><td class="source">#if !defined (get16bits)<br></td></tr
><tr
id=sl_svn151_18

><td class="source">#define get16bits(d) ((((uint32_t)(((const uint8_t *)(d))[1])) &lt;&lt; 8)\<br></td></tr
><tr
id=sl_svn151_19

><td class="source">                       +(uint32_t)(((const uint8_t *)(d))[0]) )<br></td></tr
><tr
id=sl_svn151_20
...
><td class="source">FORCE_INLINE uint16_t get16bits ( const void * p )<br></td></tr
><tr
id=sl_svn151_24
...
><td class="source">  return *(const uint16_t*)p;<br></td></tr
><tr
id=sl_svn151_26
...
><td class="source">uint32_t SuperFastHash (const signed char * data, int len) {<br></td></tr
><tr
id=sl_svn151_29

><td class="source">uint32_t hash = 0, tmp;<br></td></tr
><tr
id=sl_svn151_30

><td class="source">int rem;<br></td></tr
><tr
id=sl_svn151_31
...
><td class="source">  if (len &lt;= 0 || data == NULL) return 0;<br></td></tr
><tr
id=sl_svn151_33
...
><td class="source">  rem = len &amp; 3;<br></td></tr
><tr
id=sl_svn151_35

><td class="source">  len &gt;&gt;= 2;<br></td></tr
><tr
id=sl_svn151_36
...
><td class="source">  /* Main loop */<br></td></tr
><tr
id=sl_svn151_38

><td class="source">  for (;len &gt; 0; len--) {<br></td></tr
><tr
id=sl_svn151_39

><td class="source">    hash  += get16bits (data);<br></td></tr
><tr
id=sl_svn151_40

><td class="source">    tmp    = (get16bits (data+2) &lt;&lt; 11) ^ hash;<br></td></tr
><tr
id=sl_svn151_41

><td class="source">    hash   = (hash &lt;&lt; 16) ^ tmp;<br></td></tr
><tr
id=sl_svn151_42

><td class="source">    data  += 2*sizeof (uint16_t);<br></td></tr
><tr
id=sl_svn151_43

><td class="source">    hash  += hash &gt;&gt; 11;<br></td></tr
><tr
id=sl_svn151_44
...
><td class="source">  /* Handle end cases */<br></td></tr
><tr
id=sl_svn151_47

><td class="source">  switch (rem) {<br></td></tr
><tr
id=sl_svn151_48

><td class="source">    case 3:	hash += get16bits (data);<br></td></tr
><tr
id=sl_svn151_49

><td class="source">        hash ^= hash &lt;&lt; 16;<br></td></tr
><tr
id=sl_svn151_50

><td class="source">        hash ^= data[sizeof (uint16_t)] &lt;&lt; 18;<br></td></tr
><tr
id=sl_svn151_51
...
><td class="source">    case 2:	hash += get16bits (data);<br></td></tr
><tr
id=sl_svn151_54
...
><td class="source">        hash += hash &gt;&gt; 17;<br></td></tr
><tr
id=sl_svn151_56
...
><td class="source">    case 1: hash += *data;<br></td></tr
><tr
id=sl_svn151_58

><td class="source">        hash ^= hash &lt;&lt; 10;<br></td></tr
><tr
id=sl_svn151_59

><td class="source">        hash += hash &gt;&gt; 1;<br></td></tr
><tr
id=sl_svn151_60
...
><td class="source">  /* Force &quot;avalanching&quot; of final 127 bits */<br></td></tr
><tr
id=sl_svn151_63

><td class="source">  hash ^= hash &lt;&lt; 3;<br></td></tr
><tr
id=sl_svn151_64

><td class="source">  hash += hash &gt;&gt; 5;<br></td></tr
><tr
id=sl_svn151_65

><td class="source">  hash ^= hash &lt;&lt; 4;<br></td></tr
><tr
id=sl_svn151_66
...
><td class="source">  hash ^= hash &lt;&lt; 25;<br></td></tr
><tr
id=sl_svn151_68

><td class="source">  hash += hash &gt;&gt; 6;<br></td></tr
><tr
id=sl_svn151_69
...
><td class="source">void SuperFastHash     ( const void * key, int len, uint32_t /*seed*/, void * out )<br></td></tr
><tr
id=sl_svn151_74
...
><td class="source">  *(uint32_t*)out = SuperFastHash((const signed char*)key,len);<br></td></tr
><tr
id=sl_svn151_76
...
<script type="text/javascript">
 ...
 by tanjent
 on Feb 29, 2012
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=144&amp;format=side&amp;path=/trunk/SuperFastHash.cpp&amp;old_path=/trunk/SuperFastHash.cpp&amp;old=128">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/SuperFastHash.cpp';
 ...
 by aappl...@google.com
 on Apr 8, 2011
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=128&amp;format=side&amp;path=/trunk/SuperFastHash.cpp&amp;old_path=/trunk/SuperFastHash.cpp&amp;old=93">Diff</a>
 <br>
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/smhasher/source/detail?spec=svn151&r=93">r93</a>
 by tanjent
 on Mar 19, 2011
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=93&amp;format=side&amp;path=/trunk/SuperFastHash.cpp&amp;old_path=/trunk/SuperFastHash.cpp&amp;old=92">Diff</a>
 <br>
 <pre class="ifOpened">And add stdio.h so <a title="Info about Paul Hsieh's SuperFastHash" href="/p/smhasher/wiki/SuperFastHash">SuperFastHash</a> has a
reference to NULL
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/smhasher/source/detail?spec=svn151&r=92">r92</a>
 by tanjent
 on Mar 19, 2011
 &nbsp; <a href="/p/smhasher/source/diff?spec=svn151&r=92&amp;format=side&amp;path=/trunk/SuperFastHash.cpp&amp;old_path=/trunk/SuperFastHash.cpp&amp;old=90">Diff</a>
 <br>
 <pre class="ifOpened">Remove leftover references to
pstdint.h that break Ubuntu build

</pre>
 </div>
 
 
 <a href="/p/smhasher/source/list?path=/trunk/SuperFastHash.cpp&start=144">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//smhasher.googlecode.com/svn/trunk/SuperFastHash.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn151': '/trunk/SuperFastHash.cpp'}
 codereviews = CR_controller.setup(
 {"assetVersionPath": "https://ssl.gstatic.com/codesite/ph/11104804043454007890", "profileUrl": "/u/109814223914636253922/", "loggedInUserEmail": "alanparsonsproject28@gmail.com", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "relativeBaseUrl": "", "projectHomeUrl": "/p/smhasher", "projectName": "smhasher", "token": "imrLjL84zQJ_DZTM7KXCfS6_3kU:1390098539271", "domainName": null}, '', 'svn151', paths,
