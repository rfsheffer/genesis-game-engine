...
{
    /**
     * Invisible to program function call for setting up the performance
     * timer conversion from cycles to second and back.
     */
    static double cyclesToSecondsFrac = 0.0;
    
    //--------------------------------------------------------------------------
    /**
     * Sets up the scalar to convert cycles to seconds
     */
    ...
    //--------------------------------------------------------------------------
    /**
     * This uses the mach timer CPU frequency to convert the CPU
    ...
    //--------------------------------------------------------------------------
    /**
     * Converts a time in seconds to a performance time
     */
