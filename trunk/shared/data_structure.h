...
#define DEFINE_NULLOBJ()  { OBJ_VOID, 0, 0, 0, 0, 0, 0 },
...
{
	// Object Information
	objtype_t			objType;			// Type of Data Stored.
	const char			*objname;			// Name of Stored Variable Offset
	int					objoffset;			// Offset to Object in Class or Struct
	unsigned short		numobjs;			// Number of Objects ( ex. Array of chars )
	int					objSize;			// Size of object in bytes.
...
struct datamap_t
{
	...
	int					NumObjs;			// Number of Stored Objects.
