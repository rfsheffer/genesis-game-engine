...
#pragma once
   ...
   #define CRNLIB_LITTLE_ENDIAN_CPU 1
#ifdef _MAC
// I'm working on getting this working again, there are a number of
// differences on the mac ( spinlocks and semaphores ) which need to be dealt with ~Ryan
    #define CRNLIB_USE_PTHREADS_API 0
#else
